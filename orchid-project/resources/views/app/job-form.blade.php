                ...
                <div class="tp-contact-form-wrap tp-application-form-wrap">
                    <form id="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="tp-contact-form-input mb-20">
                                    <label>why you decided to apply hare and why should we
                                        select you?*
                                    </label>
                            ...
                            <div class="col-lg-12">
                                <div class="tp-contact-form-input mb-20">
                                    <label>Tell us About a project that you worked on and
                                        felt proud of IT.
                                    </label>
                                    <textarea name="message"></textarea>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="tp-contact-form-input mb-20">
                                    <label>your current salary & what are your salary
                                        expectations?*
                                    </label>
                                    <textarea name="message"></textarea>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div
                                    class="tp-application-form-btn d-flex justify-content-between">
